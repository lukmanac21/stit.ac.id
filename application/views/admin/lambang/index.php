                ...
                <div class="block block-rounded">
                        ...
                        <div class="block block-rounded">
                                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#btabs-animated-slideup-home">Data lambang</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="block-content tab-content overflow-hidden">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell font-size-sm">
                                                        <img src="<?= base_url()?>assets/images/logo/<?= $rlambang->nama?>" width="100px" height="70px" alt="">
                                                </td>
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?= site_url('Administrator/lambang/edit_data/'.$rlambang->id);?>" type="button" class="btn btn-sm btn-alt-primary"  title="Edit">
                                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-sm btn-alt-primary" data-toggle="modal" data-target="#delete<?= $rlambang->id?>" title="Delete">
                                    ...
                                    <?php foreach($lambang as $rlambang){?>
                                        <div class="modal fade" id="delete<?= $rlambang->id?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded block-themed block-transparent mb-0">
                                                        ...
                                                        <form action="<?= site_url('Administrator/lambang/Delete_data')?>" method="POST">
                                                            <p>Hapus data <?= $rlambang->keterangan?> ?</p>
                                                            <input type="hidden" name ="id" value="<?= $rlambang->id?>">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade fade-up" id="btabs-animated-slideup-profile" role="tabpanel">
                                        <form class="js-validation" action="<?= site_url('Administrator/lambang/Save_data');?>" method="POST" enctype="multipart/form-data">
                                            <div class="block block-rounded">
                                                <div class="block-content block-content-full">
                                                    <!-- Regular -->
