                ...
                <div class="block block-rounded">
                        ...
                        <div class="block block-rounded">
                                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#btabs-animated-slideup-home">Data Kolom Mahasiswa</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="block-content tab-content overflow-hidden">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell font-size-sm">
                                                    <?= $rkolommhs->keterangan?>
                                                </td>
                                                <td width="1%" class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?= site_url('Administrator/Kolommhs/edit_data/').$rkolommhs->id;?>" type="button" class="btn btn-sm btn-alt-primary"  title="Edit">
                                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-sm btn-alt-primary" data-toggle="modal" data-target="#delete<?= $rkolommhs->id?>" title="Delete">
                                    ...
                                    <?php foreach($kolommhs as $rkolommhs){?>
                                        <div class="modal fade" id="delete<?= $rkolommhs->id?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded block-themed block-transparent mb-0">
                                                        ...
                                                        <form action="<?= site_url('Administrator/Kolommhs/Delete_data')?>" method="POST">
                                                            <p>Hapus data <?= $rkolommhs->judul?> ?</p>
                                                            <input type="hidden" name ="id" value="<?= $rkolommhs->id?>">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade fade-up" id="btabs-animated-slideup-profile" role="tabpanel">
                                        <form class="js-validation" action="<?= site_url('Administrator/Kolommhs/Save_data');?>" method="POST" enctype="multipart/form-data">
                                            <div class="block block-rounded">
                                                <div class="block-content block-content-full">
                                                    <!-- Regular -->
