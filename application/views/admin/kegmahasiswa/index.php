            ...
            <?php $this->load->view('admin/part/sidebar');?>
                        ...
                        <div class="content content-full">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center mt-5 mb-2 text-center text-sm-left">
                                <div class="flex-sm-fill">
                                    <h1 class="font-w600 text-white mb-0 invisible" data-toggle="appear">Kegiatan</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block block-rounded">
                        <div class="block-header">
                            <h3 class="block-title">Data <small>Kegiatan</small></h3>
                        </div>
                        <div class="block-content block-content-full">
                        <div class="block block-rounded">
                                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#btabs-animated-slideup-home">Data Kegiatan</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="block-content tab-content overflow-hidden">
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="d-none d-sm-table-cell" style="width: 30%;">Nama Kegiatan</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="font-w600 font-size-sm">
                                                    <img src="<?= base_url()?>assets/images/kegiatan/<?= $rkegiatan->file?>" width="100px" height="70px" alt="">  
                                                </td>
                                    ...
                                    <?php foreach($kegiatan as $rkegiatan){?>
                                        <div class="modal fade" id="delete<?= $rkegiatan->id?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded block-themed block-transparent mb-0">
                                                        ...
                                                        <form action="<?= site_url('Administrator/Kegmahasiswa/Delete_data')?>" method="POST">
                                                            <p>Hapus data <?= $rkegiatan->judul?> ?</p>
                                                            <input type="hidden" name ="id" value="<?= $rkegiatan->id?>">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade fade-up" id="btabs-animated-slideup-profile" role="tabpanel">
                                        <form class="js-validation" action="<?= site_url('Administrator/Kegmahasiswa/Save_data');?>" method="POST" enctype="multipart/form-data">
                                            <div class="block block-rounded">
                                                <div class="block-content block-content-full">
                                                    <!-- Regular -->
