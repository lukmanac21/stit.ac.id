        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <?php $this->load->view('admin/part/sidebar');?>
                ...
                <div class="block block-rounded">
                        ...
                        <form class="js-validation" action="<?= site_url('Administrator/Penelitian/update_data');?>" method="POST" enctype="multipart/form-data">
                            <div class="block block-rounded">
                                    ...
                                    <div class="row items-push">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="kategori" name="kategori_id">
                                                    <?php foreach ($kategori as $rkategori){?>
                                                        <option value="<?= $rkategori->id;?>"<?php if($rpenelitian->kategori_id == $rkategori->id) echo "selected = 'selected'"?>><?= $rkategori->nama;?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="judul">Judul <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul File" value="<?= $rpenelitian->judul?>">
                                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $rpenelitian->id?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                <label for="tanggal">Tanggal <span class="text-danger">*</span></label>
                                                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal" value="<?= $rpenelitian->tanggal?>">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="keterangan" id="keterangan" class="js-summernote"><?= $rpenelitian->keterangan?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- END Regular -->
