<header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        <!-- User Dropdown -->
                        <div id="jam-digital">
                            <div id="hours"><p  style="color:#000;" id="jam"></p></div>
                            <div id="minute"><p style="color:#000;" id="menit"></p></div>
                            <div id="second"><p style="color:#000;" id="detik"></p></div>
                        </div>
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block ml-2"><?= $this->session->userdata('nama');?></span>
