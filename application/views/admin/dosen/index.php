                ...
                <div class="block block-rounded">
                        ...
                        <div class="block block-rounded">
                                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#btabs-animated-slideup-home">Data Dosen</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="block-content tab-content overflow-hidden">
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="d-none d-sm-table-cell" style="width: 20%;">Nama Dosen</th>
                                                <th class="d-none d-sm-table-cell" style="width: 20%;">Gambar</th>
                                                <th class="d-none d-sm-table-cell" style="width: 15%;">Mata Kuliah</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <img src="<?= base_url()?>assets/images/dosen/<?= $rdosen->file?>" width="50%" alt="">  
                                                </td>
                                    ...
                                    <?php foreach($dosen as $rdosen){?>
                                        <div class="modal fade" id="delete<?= $rdosen->id?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded block-themed block-transparent mb-0">
                                                        ...
                                                        <form action="<?= site_url('Administrator/dosen/Delete_data')?>" method="POST">
                                                            <p>Hapus data <?= $rdosen->nama?> ?</p>
                                                            <input type="hidden" name ="id" value="<?= $rdosen->id?>">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade fade-up" id="btabs-animated-slideup-profile" role="tabpanel">
                                        <form class="js-validation" action="<?= site_url('Administrator/dosen/Save_data');?>" method="POST" enctype="multipart/form-data">
                                            <div class="block block-rounded">
                                                <div class="block-content block-content-full">
                                                    <!-- Regular -->
