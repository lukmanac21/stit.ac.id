            ...
            <?php $this->load->view('admin/part/sidebar');?>
                        ...
                        <div class="content content-full">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center mt-5 mb-2 text-center text-sm-left">
                                <div class="flex-sm-fill">
                                    <h1 class="font-w600 text-white mb-0 invisible" data-toggle="appear">Struktur</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block block-rounded">
                        <div class="block-header">
                            <h3 class="block-title">Data <small>Struktur</small></h3>
                        </div>
                        <?php foreach($struktur as $rstruktur){?>
                        <form class="js-validation" action="<?= site_url('Administrator/Strukturorg/update_data');?>" method="POST" enctype="multipart/form-data">
                            <div class="block block-rounded">
                                    ...
                                    <div class="row items-push">
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan" value="<?= $rstruktur->keterangan;?>">
                                                <input type="hidden" class="form-control" id="id" name="id" value=<?= $rstruktur->id;?>>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="form-group">
