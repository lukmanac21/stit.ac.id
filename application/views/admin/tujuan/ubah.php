            ...
            <?php $this->load->view('admin/part/sidebar');?>
                ...
                <div class="block block-rounded">
                        ...
                        <?php foreach($tujuan as $rtujuan){?>
                            <form class="js-validation" action="<?= site_url('Administrator/tujuan/update_data');?>" method="POST" enctype="multipart/form-data">
                                <div class="block block-rounded">
                                        ...
                                        <div class="row items-push">
                                            <div class="col-lg-12 col-xl-12">
                                                <div class="form-group">
                                                    <label for="tanggal">Tujuan <span class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="tujuan" name="tujuan" placeholder="Nama tujuan"><?= $rtujuan->tujuan?></textarea>
                                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $rtujuan->id?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END Regular -->
