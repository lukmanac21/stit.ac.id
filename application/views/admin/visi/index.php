                ...
                <div class="block block-rounded">
                        ...
                        <div class="block block-rounded">
                                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#btabs-animated-slideup-home">Data Visi</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="block-content tab-content overflow-hidden">
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                        ...
                                        <?php $no=1; foreach($visi as $rvisi){?>
                                        <tbody>
                                            <tr>
                                            <td class="font-w600 font-size-sm">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="<?= site_url('Administrator/Visi/edit_data/'.$rvisi->id)?>" type="button" class="btn btn-sm btn-alt-primary" title="Edit">
                                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                                        </a>
                                                        <button type="button" class="btn btn-sm btn-alt-primary" data-toggle="modal" data-target="#delete<?= $rvisi->id?>" title="Delete">
                                    ...
                                    <?php foreach($visi as $rvisi){?>
                                        <div class="modal fade" id="delete<?= $rvisi->id?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-rounded block-themed block-transparent mb-0">
                                                        ...
                                                        <form action="<?= site_url('Administrator/Visi/Delete_data')?>" method="POST">
                                                            <p>Hapus data <?= $rvisi->visi?> ?</p>
                                                            <input type="hidden" name ="id" value="<?= $rvisi->id?>">
                                                        </div>
                                    ...
                                    <div class="tab-pane fade fade-up" id="btabs-animated-slideup-profile" role="tabpanel">
                                        <form class="js-validation" action="<?= site_url('Administrator/Visi/Save_data');?>" method="POST" enctype="multipart/form-data">
                                            <div class="block block-rounded">
                                                <div class="block-content block-content-full">
                                                    <!-- Regular -->
