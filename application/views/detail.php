                    ...
                    <div class="col-lg-8">
                        <div class="blog-one__single">
                            <div class="blog-one__image">
                                <img src="<?= base_url()?>assets/images/berita/<?= $rrpengembangan->images?>"  width="370px" height="680px" alt="">
                            </div><!-- /.blog-one__image -->
                            <div class="blog-one__content text-center">
                                <h2 class="blog-one__title"><?= $rrpengembangan->judul?>

                                </h2><!-- /.blog-one__title -->
                                <p><?= $rrpengembangan->isi_berita?></p>
                            ...
                            <div class="share-block">
                                ...
                                <div class="right-block">
                                    <p>Post On: <?= $rrpengembangan->tanggal;?></p>
                                </div><!-- /.left-block -->
                            </div>
